    ...
    <div class="flex-grow-1 p-4">
      ...
      <div class="border rounded p-4">
        ...
        <div class="d-flex align-items-center gap-2">
          ...
          <h1 class="fs-4 fw-bold t-primary m-0">Edit Product</h1>
        </div>
        <div class="container mt-4">
          <form action="../includes/update_product.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group my-2">
              ...
              <div class="form-text" id="basic-addon4">Noted: leave product photos blank if there is nothing to update</div>
            </div>
            <div class="form-group my-2">
